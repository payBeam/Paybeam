        ...
        >
          {selectedInvoice && (
            <Descriptions bordered column={1}>
              <Descriptions.Item label="Invoice ID">{selectedInvoice.invoiceId}</Descriptions.Item>
              <Descriptions.Item label="Amount">${selectedInvoice.amount}</Descriptions.Item>
              <Descriptions.Item label="Due Date">{selectedInvoice.dueDate}</Descriptions.Item>
              <Descriptions.Item label="Status">{selectedInvoice.status}</Descriptions.Item>
            </Descriptions>
          )}
        </Modal>
      </div>
