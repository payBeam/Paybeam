    ...
    <section className="section bg-gradient-to-b from-[#f8f9fb] to-[#fafbff] text-customPurple">
      <div className="container mx-auto">
        <h2 className="section-title text-center mb-16">
          Unlock the future of digital battles with Meme War—create or compete using memes, tokens,
          or NFTs in a secure, community-driven arena for ultimate supremacy!
        </h2>
        {/* items */}
